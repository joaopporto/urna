...
def presidenteNum():
    ...
    print(voto22)
    return voto22, voto13, votoBrancoP

arqSaida = open('urnaResultados.csv', 'w')
arqSaida.write('cargo;nome;num;partido;img;votos\n'+'presidente;Bozo;22;PL;FgYX3pJXkAISa95.png;\n'+'presidente;Lula;13;PT;lula-1200x900.png;\n'+'presidente votos brancos: '+'governador;Penna;17;C3;penna.png;\n'+'governador;Bicho;12;C3;alessandro.png;\n'+'governador votos brancos: ')
arqSaida.close()
